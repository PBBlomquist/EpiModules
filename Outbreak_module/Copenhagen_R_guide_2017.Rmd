...
#Download the case study files

Download the files needed for this case study here: <a href="https://github.com/PBBlomquist/EpiModules/blob/master/Outbreak_module/Copenhagen_files.zip?raw=true" download="Copenhagen_files.zip" target="_blank"> download Copenhagen_files.zip </a>

Note that files for all case studies can also be downloaded directly from the menu bar to the left. 
...
Read in the dataset Copenhagen_raw.csv, from the zip of case study files, using the *read_csv* command.  
