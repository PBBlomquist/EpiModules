...
Download the dataset <a href="https://github.com/PBBlomquist/EpiModules/blob/master/Outbreak_module/Copenhagen_raw.csv" download="Copenhagen_raw.csv" target="_blank"> Copenhagen_raw.csv </a> using the *read_csv* command.  
