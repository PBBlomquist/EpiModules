...
The case studies in this GitBook were designed under an ECDC service contract for the development of training material (2010). The data were slightly modified for training purposes.

All code has been adapted to *R* for learning purposes. The initial contributors and copyright license are listed within each page. All copyrights and licenses of the original document apply here as well. 
